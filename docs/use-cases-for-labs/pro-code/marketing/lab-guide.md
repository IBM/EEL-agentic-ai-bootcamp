...
??? tip "INSTRUCTORS TO SETUP THE RETAIL DATA IN WATSONX.DATA !"
    Instructors need to setup the retail data in watsonx.data before demonstrating this feature.
...
??? tip "INSTRUCTORS TO DEPLOY MCP SERVER ON CODE ENGINE !"
