...
- **Instructors**: Please make sure you have completed the [instructor setup](https://github.ibm.com/skol/agentic-ai-client-bootcamp-instructors/tree/main/usecase-setup/intelligent-assistant) before the bootcamp. You will need to provide the API key and endpoint URL to the participants. 
