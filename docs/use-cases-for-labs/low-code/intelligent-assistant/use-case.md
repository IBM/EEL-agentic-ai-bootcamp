...
You can find step-by-step instructions in [this document](./lab-guide.md). It shows how you can implement the use case using watsonx.ai and watsonx Orchestrate. 
